...
const jobSchema = new mongoose.Schema({
  ...
  careerGroupNameSnapshot: { type: String, default: null },
  careerId: { type: objectId, ref: 'Career', required: true },
  careerNameSnapshot: { type: String, default: null },
  careerPositionId: { type: objectId, ref: 'CareerPosition', required: true },
  careerPositionNameSnapshot: { type: String, default: null },
  jobLevelId: { type: objectId, ref: 'JobLevel', required: true },
  jobLevelNameSnapshot: { type: String, default: null },
  companyNameSnapshot: { type: String, default: null },
  companyLogoSnapshot: { type: String, default: null },
  experience: { type: String, required: true },
  skills: [{ type: objectId, ref: 'Skill' }],
  skillNameSnapshots: { type: [String], default: [] },
  salary: {
