...
export const inviteToInterview = async (req, res) => {
  try {
    ...
    const { candidateId } = req.params;
    const { jobId, interviewTime, interviewType, location, contactPerson, contactPhone, note } = req.body;
